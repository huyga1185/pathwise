...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handADE(AuthorizationDeniedException ade) {
        return build(null, null, HttpStatus.FORBIDDEN, ade);
    }
    ...
    public ResponseEntity<ErrorResponse> handleMRCE(MissingRequestCookieException mrce) {
        return build(
                null,
                null,
                HttpStatus.BAD_REQUEST,
